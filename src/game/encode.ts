...
function encodeStory(npcCount: number, storySoFar: string, appendLength: AppendLength) {
    return `You are being used in a video game to simulate behavior of ${npcCount} NPCs.  There is one player that will interact with NPCs controlled by you through text based chat.
...
CONVERSATION_START
    Player: hi how r u?
    Ryan: I am doing well.  How are you?
    Player: can you go catch a fish for our party tonight?
